...
class BookStore {
     ...
     */
    public static void main(String[] args) throws IllegalNovelPropertyException, IllegalNameException {
        BookStore b = new BookStore( args[0] );
        b.printAllTitles();

        System.out.println("---");
        b.printAllTitlesContaining("the", false);

        System.out.println("---");
        b.printAllTitlesContaining("the", true);
