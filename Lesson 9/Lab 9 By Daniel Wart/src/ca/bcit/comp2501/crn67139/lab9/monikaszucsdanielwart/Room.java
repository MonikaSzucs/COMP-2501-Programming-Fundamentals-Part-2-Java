...
public class Room {
    ...
    /**
     * Method to buy more electronics
     *
     * @param e used to grab value from the Electronic Class
     */
    ...
    /**
     * This is the sell's electronics method
     *
     * @param index finds the index of the electronics
     */
    ...
    /**
     * This is to check number of electronics stored
     * @return the size (number) of electronics stored
     */
    ...
    /**
     * This is a Method that will check the instance of the different types of electronics
     */
    public void test() {
    ...
    /**
     * This is a method that will check tp get the budget of the different electronics
     *
     * @param e is the electronic that is being stored
     * @return the budget of the eletronic in Canadian Dollars
     */
     ...
     *
     * @return this will return the toString of each of the electronics to display to the users.
     */
    @Override
